...
var workers; // is the Worker API is available, this represents a list of workers which can be used to differ various tasks such as running simulations. Uses the Worker variable imported from the Worker file.
