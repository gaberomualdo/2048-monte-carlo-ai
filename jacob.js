...
function simulateRun(move, move_index){
	...
	if(totalGamesDone >= gamesPerMove * 4){
		...
		document.querySelector("div.console").innerHTML += ("<p>Best move was " + bestMove.toUpperCase() + " with an average score of " + parseFloat(Math.max(...totalMoveScores) / gamesPerMove).toFixed(2) + " and " + gamesPerMove + " simulations per move.</p>");
		(function(){
